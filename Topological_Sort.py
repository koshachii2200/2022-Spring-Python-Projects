...
# Description: Implements the Topological Sort and runs it on an inputted graph
...
class Graph(object):
    ...
    # finds if graph is cyclic; returns false if acyclic
    def has_cycle(self):
        pass
    ...
    def toposort(self):
        ...
        for i in range(21):
            if visited[i] == False:
                self.topologicalSortUtil(i, visited, topoList)

        # Print contents of the stack
        print(topoList[::-1])  # return list in reverse order
