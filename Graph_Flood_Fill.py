#  File: GraphFill.py
#  Description: Builds a graph, prints its adjacency matrix and
#       implements Breadth-First Search and Depth-First Search to flood fill pixels in images.
        ...
        while not stack.is_empty():
            ...
            if u == -1:
                ...
                if self.nodes[u].color == colorChange:
                    ...
                    self.print_image()
                #if self.nodes[u].prev_color != color:
                #    self.print_image()
